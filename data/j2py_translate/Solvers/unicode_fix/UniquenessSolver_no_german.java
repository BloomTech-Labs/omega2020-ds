...
public class UniquenessSolver extends AbstractSolver {
     ...
     * - wenn eine Zelle die selben zwei Kandidaten (plus beliebig viele andere) hat, fur beide Zellen
     *   die Unit2 finden
     * - Alle Zellen dieser Unit2(s) durchgehen, die nicht im selben Block wie die Unit1(s) sind
     * - Wenn beide Zellen die selben beiden Kandidaten haben -> mogliches Unique Rectangle, SolutionStep prufen
     *
